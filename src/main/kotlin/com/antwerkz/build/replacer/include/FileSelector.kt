...
class FileSelector {
    ...
    companion object {
         ...
         * then don't set the DirectoryScanner's basedir which allows absolute paths to work. Don't
         * like doing this, but it may be the only workaround for existing users and the turn around
         * time for finding issues and releases is large with maven central.
         */
